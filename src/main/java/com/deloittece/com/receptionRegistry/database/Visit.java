...
public class Visit implements Persistable<Long> {
	...
	public Visit(Long visitId, Visitor visitor, Employee employee, Date arrivalDate, Date arrivalTime, Date dateOfExit,
			String badgeNumber, Date dateOfBadgeReceive, Timestamp timestamp, boolean exitWasSetAuto,
			BadgeType badgeType) {
		super();
		this.visitId = visitId;
		this.visitor = visitor;
	...
	public Visit(Long visitId, Visitor visitor, Employee employee, String badgeNumber, boolean exitWasSetAuto,
			BadgeType badgeType) {
		super();
		this.visitId = visitId;
		this.visitor = visitor;
